function [measurement] = gen_sim_imucalib( )
%   
%   Outputs:
...
% IMU bias parameters
wb = [0.05 0.12 0.23]';%[0 0 0]';%
ab = [0.08 0.20 0.14]';%[0 0 0]';% 
...
while imu_t < t_end || omn_t < t_end
    ...
    if imu_t <= omn_t
       ...
       measurement.True(end+1, :) = [rb; Tb; wt; Td; TD; wb; ab; g0];
